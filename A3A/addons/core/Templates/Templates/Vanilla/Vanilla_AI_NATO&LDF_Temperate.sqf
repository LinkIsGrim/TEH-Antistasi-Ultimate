...
private _cargoTrucks = ["B_T_Truck_01_flatbed_F", "B_T_Truck_01_cargo_F","I_E_Truck_02_transport_F", "I_E_Truck_02_F"];
...
private _airborneVehicles = ["B_T_APC_Wheeled_01_cannon_F","I_E_APC_tracked_03_cannon_F"];
private _lightTanks = [];

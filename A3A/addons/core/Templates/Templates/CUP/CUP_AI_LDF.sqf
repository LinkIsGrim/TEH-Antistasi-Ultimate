...
_sfLoadoutData set ["vests", ["CUP_V_CPC_light_rngr"]];
_sfLoadoutData set ["mgVests", ["CUP_V_CPC_Fast_rngr"]];
_sfLoadoutData set ["medVests", ["CUP_V_CPC_medical_rngr"]];
_sfLoadoutData set ["glVests", ["CUP_V_CPC_weapons_rngr"]];
...
_eliteLoadoutData set ["vests", ["CUP_V_CPC_light_rngr"]];
_eliteLoadoutData set ["slVests", ["CUP_V_CPC_tl_rngr"]];
_eliteLoadoutData set ["mgVests", ["CUP_V_CPC_Fast_rngr"]];
_eliteLoadoutData set ["glVests", ["V_PlateCarrierIAGL_oli"]];
...
_militaryLoadoutData set ["vests", ["CUP_V_CPC_light_rngr"]];
_militaryLoadoutData set ["mgVests", ["CUP_V_CPC_Fast_rngr"]];
_militaryLoadoutData set ["medVests", ["CUP_V_CPC_medical_rngr"]];
_militaryLoadoutData set ["slVests", ["CUP_V_CPC_tl_rngr"]];
_militaryLoadoutData set ["glVests", ["CUP_V_CPC_weapons_rngr"]];
_militaryLoadoutData set ["engVests", ["V_PlateCarrierIAGL_oli"]];

/*  Get howitzer support selection weight against target
...
if ({sidesX getVariable [_x, sideUnknown] == _side} count (airportsX + milbases) == 0) exitWith { 0 }; //howitzers are stationed at big outposts

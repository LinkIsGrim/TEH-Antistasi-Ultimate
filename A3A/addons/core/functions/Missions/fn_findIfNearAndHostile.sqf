...
_markers = _markers select {((getMarkerPos _x distance2D getMarkerPos _nearestMarkers) < (distanceMission + tierWar * distanceMissionTier)) && (sidesX getVariable [_x,sideUnknown] != teamPlayer)};

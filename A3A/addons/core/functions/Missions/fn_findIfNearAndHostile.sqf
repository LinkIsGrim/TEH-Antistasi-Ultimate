...
_markers = _markers select {((getMarkerPos _x distance2D getMarkerPos _nearestMarkers) < (distanceMission + tierWar * TEH_distanceMissionTier)) && (sidesX getVariable [_x,sideUnknown] != teamPlayer)};

...
class radioComm: SimpleMenuBigger
{
	...
	class Controls
	{
		...
		class l3Button: SimpleButton
		{
			...
			action = "closeDialog 0; _target = cursorObject; if (isNull _target) then { _target = cursorTarget; }; [_target] remoteExec ['JN_fnc_arsenal_turretUnload', 2]; [_target, clientOwner, call HR_GRG_dLock, player] remoteExec ['HR_GRG_fnc_addVehicle', 2];";
		};
